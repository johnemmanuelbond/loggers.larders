...
> 
> Actually, the back wall is the only flat surface in the room. The right and left walls themselves curve seamlessly into the floor where, dominating your attention, a dusty pile broken stonework, ruined metal, and other debris fills the last couple feet of the descent. It's topped by this broken glass encasement filled with a familiar red fluid. The remains of a rotten wooden plank dangles above it by a chain from the arched ceiling.
> 
...
- Occasional “pops” of air pressure where the ooze’s body once writhed.
- Dim red glow at floor level, fading in and out with the rhythm of breath.
- Soft whispering from the stone arch — just air, or maybe residual consciousness. 

**Hazards:**
- The slimy ooze makes climbing around rather difficult, to climb down is a DC 13 acrobatics check to avoid falling (1-2 d6 bludgeoning depending on fail degree)
- Climbing up is a DC 16 athletics check (without a rope or some kind of help)
- Falling onto the debris pile is extremely risky. If you fall, roll a 6 on a d6, you take 1 piercing damage and need to make a DC 15 con save or take 2d4 poison damage and become poisoned.
- The whole area is difficult terrain

| **Check Type**               | **DC 10**                                                                    | **DC 13**                                                                                        | **DC 16**                                                                                                                           | **DC 20+**                                                 |
| ---------------------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| **Perception**               | A few intact crates are jammed in the corner: 1 roll on the loot table.      | The slime’s residue crackles faintly under torchlight — harmless now, but still faintly magical. | There are faint, circular impressions along the back wall near the ring— something round and metallic was dragged through long ago. | 1 more roll on the loot table                              |
| **Investigation / Survival** | 1 roll on the loot table                                                     | Stuck in a layer of hardened slime, you find a **brass casing**<br>(*astrolabe component 1*)     |                                                                                                                                     | 2 rolls on the loot table<br>(but takes a long time)       |
| **Arcana / History**         | Each of the ring of stones has what looks like an inert magical glyph on it. | *(if elvish)*<br>the runes look vaguely elvish.                                                  | *(if applicable)*<br>That **casing** is just not possible to craft conventionally                                                   | *(if applicable)*<br>The way those rings on the **casing** |

-> **brass casing**: a hollow brass encasement. Smooth and plain on the outside, but if you look within you see beautiful and impossible embossed patterns of spirals and wisps. amongst the patterns are five significantly larger rings, each with a different color: *grey, red, dark blue, pale blue, white*.

| **d10** | **Item Found**                                                                                                                                                                                                                                                                                                          |
| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1       | [Junk](https://tabletoptrinketsbyjj.tumblr.com/post/187125822272/all-trinkets-a-working-rolling-table-of-all-the)                                                                                                                                                                                                       |
| 2       | **Sealed brass flask** labeled “Alchemic Residue – DO NOT OPEN.” The seal is intact; DC 18 Arcana reveals it stabilizes volatile matter. Worth 30 gp.<br>-> [Junk](https://tabletoptrinketsbyjj.tumblr.com/post/187125822272/all-trinkets-a-working-rolling-table-of-all-the)                                           |
| 3       | **A few salvageable potions** – roll d4: (1) Potion of Healing, (2) Potion of Climbing, (3) random experimental potion (DM’s choice), (4) inert fluid with faint shimmer, worthless but pretty.<br>-> [Junk](https://tabletoptrinketsbyjj.tumblr.com/post/187125822272/all-trinkets-a-working-rolling-table-of-all-the) |
| 4       | **Half-burnt wizard’s notes** _in elvish_ describing containment protocols for “Specimen 6R: Self-Replicating Gel.” Mentions “dimensional feed instability.”<br>-> [Junk](https://tabletoptrinketsbyjj.tumblr.com/post/187125822272/all-trinkets-a-working-rolling-table-of-all-the)                                    |
...
- Periodically you hear a whisper in your ear, it starts low but grows the longer you spend in here and the closer you get to the 
...
> 5. A stark white disk and a completely scratched out rune: *Asto* (meaning dust)
...
- **Spinning the astrolabe:**
	...
	- Rewards:
	    - **Vision:** Once active, it emits faint light and hums at resonant frequencies — enough to make loose stones tremble, and it projects an image:
...
> As you drop through the crack in the floor, everything changes. That perpetual dust in the air vanishes and you breathe more clearly. The scent of musk is replaced by ozone. the walls in here are seamless black slate and in protruding straight out from the wall is a perfectly circular pedestal with a circle of vibrantly glowing white runes.
> 
> The longer you stay in here the more you notice your body resonate and your bones hum with the rhythmic pulsing of those runes. This is powerful, powerful magic. As you position yourself to peer directly at the circle, where you expect to see stone you instead see a **mist-shrouded forest of silver-blue trees**, their trunks tall and impossibly straight, branches interlacing overhead. Make a perception check:

| **DC** | Discovery                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 10     | Faint beams of pale moonlight pierce the fog, illuminating glimpses of something massive moving between the trunks. Only fragments are visible through the frame of this circle: a long, spindly limb crashes into the ground, a series of wicked-looking spikes graze up against the canopy, all in silhouette and shadow against the mist. A low, hollow rumble resonates, like distant thunder mixed with scraping metal, echoing off these enormous trees in a discordant chorus. It makes the hairs on your neck bristle. |
...
| **12**  | Against the wall there is an intact desk with embedded protective runes. In a locked drawer a heat-proof container holds several personal notes, perfectly preserved.                                                                                                                      |
...
| **20+** | Roll on the [Highly magic items](https://tabletoptrinketsbyjj.tumblr.com/post/187125394177/all-artifacts-a-working-rolling-table-of-all-the)                                                                                                                                               |
...
In it's heyday it contained the following rooms:
1. Main Hall
2. Labyrinth
3. Master's Atrium
4. Teleportation Chamber
5. Animated Kitchen
6. Extraplanar Study / Alchemy Laboratory
7. Upper Balcony
8. Master's Apartments
9. Library
10. Sitting Room
11. Guest Apartments
12. Obsevatory (chamber of knowing stars)